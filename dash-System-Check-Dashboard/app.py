    ...
    return html.Div(
        ...
        children=[
            html.Div(
                id="banner-text",
                children=[
                    html.H5("Trimble Fleet Predictive Maintenance Portal"),
                    html.H6("By Henil Patel(Trimble MAPS)"),
                ],
            ),
            html.Div(
                id="banner-logo",
                children=[
                    ...
                    html.Img(id="logo", src=app.get_asset_url("logo-trimble.png")),
                ],
            ),
        ],
    )
            ...
            dcc.Tabs(
                ...
                children=[
                    ...
                    dcc.Tab(
                        ...
                        label="Vehicle System Check Dashboard",
                        value="tab2",
                        className="custom-tab",
                        selected_className="custom-tab--selected",
                    ),
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                id="card-2",
                children=[
                    html.P("Remaining Useful Life(RUL)"),
                    daq.Gauge(
                        id="progress-gauge",
                        max=max_length * 2,
                        min=0,
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner("Vehicle Live Sensor Data"),
                    html.Div(
                        id="metric-div",
                        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner("System Check by sensors"),
                    generate_piechart(),
                ],
            ),
        ],
...
def generate_metric_list_header():
    return generate_metric_row(
        ...
        {"id": "m_header_1", "children": html.Div("Sensors")},
        {"id": "m_header_2", "children": html.Div("Values")},
        {"id": "m_header_3", "children": html.Div("Live Data")},
...
def build_chart_panel():
    return html.Div(
        ...
        className="twelve columns",
        children=[
            generate_section_banner("Live SPLC Chart"),
            dcc.Graph(
